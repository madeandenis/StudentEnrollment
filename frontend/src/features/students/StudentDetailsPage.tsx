            ...
            <Paper p="md" shadow="sm" withBorder>
                <Stack gap="lg">
                    ...
                    <div>
                        ...
                        <Grid>
                            <Grid.Col span={{ base: 12, sm: 6 }}>
                                <Group gap="xs" mb="sm">
                                    <Hash size={18} strokeWidth={1.5} style={{ color: 'var(--mantine-color-dimmed)' }} />
                                    <div>
                            ...
                            <Grid.Col span={{ base: 12, sm: 6 }}>
                                <Group gap="xs" mb="sm">
                                    <Calendar size={18} strokeWidth={1.5} style={{ color: 'var(--mantine-color-dimmed)' }} />
                                    <div>
                                        <Text size="xs" c="dimmed">
                                            Data Nașterii
                                        </Text>
                            ...
                            <Grid.Col span={{ base: 12, sm: 6 }}>
                                <Group gap="xs" mb="sm">
                                    <Mail size={18} strokeWidth={1.5} style={{ color: 'var(--mantine-color-dimmed)' }} />
                                    <div>
                                        <Text size="xs" c="dimmed">
                                            Email
                                        </Text>
                            ...
                            <Grid.Col span={{ base: 12, sm: 6 }}>
                                <Group gap="xs" mb="sm">
                                    <Phone size={18} strokeWidth={1.5} style={{ color: 'var(--mantine-color-dimmed)' }} />
                                    <div>
                                        <Text size="xs" c="dimmed">
                                            Telefon
                                        </Text>
                    ...
                    <div>
                        ...
                        {student.address ? (
                            <Group gap="xs">
                                <MapPin size={18} strokeWidth={1.5} style={{ color: 'var(--mantine-color-dimmed)' }} />
                                <div>
                                    <Text size="sm" fw={500}>
                                        {student.address.address1}
                                        {student.address.address2 && `, ${student.address.address2}`}
                                    </Text>
                                    <Text size="sm" c="dimmed">

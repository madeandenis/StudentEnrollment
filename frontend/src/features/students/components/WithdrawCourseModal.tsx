    ...
    return (
        ...
        >
            <Stack gap="md">
                ...
                <Text size="sm">
                    Ești sigur că vrei să scoți studentul{' '}
                    <strong>{studentName}</strong> de la cursul{' '}
                    <strong>{courseCode} - {courseName}</strong>?
                </Text>

                <Text size="sm" c="dimmed">
                    Această acțiune va elibera un loc în curs și va actualiza lista de cursuri a studentului.
                </Text>
